...
/*   Updated: 2022/09/02 18:40:44 by cbridget         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void convert_res(float num);
void convert_res(double num);
...
void convert_to_char(char c) {
	if (!isprint(c)) {
		std::cout << "error: your input is not a displayable character!\n";
		return;
	}
	
}

void convert_to_nan(std::string &str) {
